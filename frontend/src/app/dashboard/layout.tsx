    ...
    <nav className="space-y-1 p-4">
        ...
        {isExpanded ? (
            <div className="pt-2">
                    ...
                    <div className="space-y-1">
                        ...
                        {isManagementOpen && (
                            <div className="ml-4 space-y-1 border-l pl-2">
                                ...
                                {canView("Agreement") && (
                                    <Link href="/dashboard/agreement/template" className="flex items-center space-x-2 p-2 hover:bg-muted rounded-md transition-colors text-sm" title="Agreement Template">
                ...
                {/* Control Panel */}
                {(canView("Manage Role") || canView("Manage User")) && (
                    <div className="space-y-1">
                        <button
            ...
            <div className="pt-2 flex flex-col items-center space-y-2">
                <div className="flex justify-center p-2 group relative" title="Management">
                    <Settings className="h-5 w-5 text-muted-foreground group-hover:text-foreground transition-colors cursor-pointer" />
                </div>
                <div className="flex justify-center p-2 group relative" title="Stock">
                    <Layers className="h-5 w-5 text-muted-foreground group-hover:text-foreground transition-colors cursor-pointer" />
                </div>
                <div className="flex justify-center p-2 group relative" title="Accounting">
                    <Calculator className="h-5 w-5 text-muted-foreground group-hover:text-foreground transition-colors cursor-pointer" />
                </div>
                <div className="flex justify-center p-2 group relative" title="Sale & Purchase">
                    <ArrowRightLeft className="h-5 w-5 text-muted-foreground group-hover:text-foreground transition-colors cursor-pointer" />
                </div>
                <div className="flex justify-center p-2 group relative" title="Control Panel">
